...
export const REWARD_ICONS = [
  ...
  { name: 'MailOpen', label: 'Carta Abierta' },
  { name: 'MessageCircle', label: 'Mensaje' },
  { name: 'ListChecks', label: 'Lista' },
  { name: 'ClipboardList', label: 'Lista de Tareas' },
  { name: 'ScrollText', label: 'Pergamino' },
  { name: 'Headphones', label: 'Auriculares' },
  { name: 'Radio', label: 'Radio' },
  { name: 'Disc', label: 'Disco' },
  { name: 'Guitar', label: 'Guitarra' },
  { name: 'ChefHat', label: 'Chef' },
  { name: 'CookingPot', label: 'Olla' },
  { name: 'UtensilsCrossed', label: 'Restaurante' },
  { name: 'Soup', label: 'Sopa' },
  { name: 'Walk', label: 'Caminar' },
  { name: 'Footprints', label: 'Paseo' },
  { name: 'Bike', label: 'Bicicleta' },
  { name: 'Mountain', label: 'Montaña' },
  { name: 'Trees', label: 'Naturaleza' },
  { name: 'MapPin', label: 'Lugar' },
  { name: 'Tv', label: 'TV' },
  { name: 'Monitor', label: 'Streaming' },
  { name: 'Ticket', label: 'Entrada' },
  { name: 'Drama', label: 'Teatro' },
  { name: 'Waves', label: 'Spa' },
