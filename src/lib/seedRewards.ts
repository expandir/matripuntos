...
const allRewards: RewardDef[] = [
  ...
  { name: '3 horas de tiempo libre', description: 'Tiempo personal para hacer lo que quieras', points_cost: 50, image_url: 'https://images.pexels.com/photos/1109197/pexels-photo-1109197.jpeg?auto=compress&cs=tinysrgb&w=800', icon: 'Clock', tags: ['leisure'] },
  { name: 'Trabajar en proyecto personal', description: 'Tiempo sin interrupciones para tus proyectos', points_cost: 55, image_url: 'https://images.pexels.com/photos/1181406/pexels-photo-1181406.jpeg?auto=compress&cs=tinysrgb&w=800', icon: 'Lightbulb', tags: ['leisure'] },
  ...
  { name: 'Salir con amigos', description: 'Tiempo para salir con tus amistades', points_cost: 60, image_url: 'https://images.pexels.com/photos/1267696/pexels-photo-1267696.jpeg?auto=compress&cs=tinysrgb&w=800', icon: 'Users', tags: ['dates'] },
  { name: 'Manana libre (4h)', description: 'Manana completa para ti', points_cost: 70, image_url: 'https://images.pexels.com/photos/851213/pexels-photo-851213.jpeg?auto=compress&cs=tinysrgb&w=800', icon: 'Sunrise', tags: ['leisure'] },
  { name: 'Dia sin tareas domesticas', description: 'La otra persona se hace cargo de todo', points_cost: 70, image_url: 'https://images.pexels.com/photos/4239091/pexels-photo-4239091.jpeg?auto=compress&cs=tinysrgb&w=800', icon: 'Home', tags: ['help'] },
  { name: 'Tarde libre completa (5h)', description: 'Toda la tarde sin responsabilidades', points_cost: 85, image_url: 'https://images.pexels.com/photos/1449791/pexels-photo-1449791.jpeg?auto=compress&cs=tinysrgb&w=800', icon: 'Sun', tags: ['leisure'] },
  { name: 'Noche libre de ninos', description: 'Tu pareja se encarga de los ninos toda la noche', points_cost: 80, image_url: 'https://images.pexels.com/photos/3771069/pexels-photo-3771069.jpeg?auto=compress&cs=tinysrgb&w=800', icon: 'Moon', tags: ['help', 'children'] },
  { name: 'Ir al spa o masaje', description: 'Tiempo para autocuidado profesional', points_cost: 80, image_url: 'https://images.pexels.com/photos/3757952/pexels-photo-3757952.jpeg?auto=compress&cs=tinysrgb&w=800', icon: 'Sparkles', tags: ['treats'] },
  { name: 'Dia completo libre', description: 'Todo el dia para ti', points_cost: 150, image_url: 'https://images.pexels.com/photos/1659438/pexels-photo-1659438.jpeg?auto=compress&cs=tinysrgb&w=800', icon: 'Calendar', tags: ['leisure'] },
  { name: 'Semana sin cocinar', description: 'Tu pareja cocina toda la semana', points_cost: 140, image_url: 'https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&cs=tinysrgb&w=800', icon: 'Utensils', tags: ['help'] },
  { name: 'Fin de semana libre', description: 'Sabado y domingo completos libres', points_cost: 250, image_url: 'https://images.pexels.com/photos/346529/pexels-photo-346529.jpeg?auto=compress&cs=tinysrgb&w=800', icon: 'CalendarDays', tags: ['leisure'] },
];
